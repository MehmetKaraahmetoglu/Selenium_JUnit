...
public class C04_KontrolsuzCokluWindow extends TestBase {
    ...
    public void cokluPencereTesti(){
        ...
        System.out.println("ilk sayfa whd : " + ilkSayfaWhd); //ilk sayfa whd : 6B9EF1C8B4D27A7497A2FE044CC6502B
        System.out.println("window handles seti : " + whdSeti);
        //window handles seti : [6B9EF1C8B4D27A7497A2FE044CC6502B, E81DB72387E64360E1216984983DBB87]
