...
public class C03_CokluPencere extends TestBase {
    ...
    public void test01(){
        ...
        String amazonWhd= driver.getWindowHandle(); //amazona tekrar dönebilmek icin handle ediyoruz
        ...
        Assert.assertTrue(actualUrl.contains(expectedUrlIcerik));
        String wiseWhd= driver.getWindowHandle(); //sonraki testte buraya geri dönecegim icin bunu kaydediyorum ki handle yapabileyim
