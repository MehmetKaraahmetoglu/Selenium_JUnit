...
public class C02_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        int expextedSonSatirNo=24;
        int actualSonSatirNo=sayfa2.getLastRowNum()+1;
        Assert.assertEquals(expextedSonSatirNo,actualSonSatirNo);
        ...
        Assert.assertEquals(expectedFizikiSatirSayisi,expectedFizikiSatirSayisi);

        //olmayan satir veya sutun numarasi yazdiraya calissak
