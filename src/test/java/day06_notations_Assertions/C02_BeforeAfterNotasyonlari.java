...
public class C02_BeforeAfterNotasyonlari {
    /*
    bir class'in icinde her test methodundan once calismasini istediginiz
    siradan bir method varsa o methodun basina @Before kullanirsak
    @Test method'larindan CAGIRMAYA GEREK OLMADAN
    o method her test methodundan once calisir.

    Ayni sekilde her test Method'undan sonra calismasini istedigimiz siradan bir
    method varsa
